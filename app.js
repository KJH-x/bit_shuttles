import { ROUTES, DURATION_MIN, DURATION_BY_ROUTE, DURATION_PROFILES, scheduleKind, activeTrips, CHECKPOINTS, CAMPUS, ENABLE_XISHAN } from "./schedule-data.js?v=20260915-33";
import {
  formatClock,
  formatHM,
  formatDurationLabel,
  ...
  campusStopAt,
  etaDiffMin
} from "./lib/schedule.js?v=20260915-33";
import { now, syncClock, toBeijingDateStr } from "./lib/time.js?v=20260915-33";
import { initInstallGuide } from "./lib/install-guide.js?v=20260915-33";
import { initQQBrowserGuide } from "./lib/qq-guide.js?v=20260915-33";
import {
  initAvail,
  ...
  availAgeMs,
  fetchHistoryDates
} from "./lib/availability.js?v=20260915-33";
import { initTraffic, refreshTrafficNow, trafficForRoute, realtimeDurMin, markerProgress, laneGradient } from "./lib/traffic.js?v=20260915-33";
import { initRainbow, refreshRainbowNow, rainbowAvailText, rainbowAgeMs, rainbowTripsForDate } from "./lib/rainbow.js?v=20260915-33";
import {
  readPref,
  savePref,
  readReminders,
  ...
  downloadIcs,
  schedulePwaNotify
} from "./lib/reminder.js?v=20260915-33";
